...
class SignUpForCustomerFinished extends React.Component {
                ...
                <div className="container_signup">
                    <div className="wrap_signup">
                        <div className="signup_form">
                            ...
                            <h5 style={{color:"#CB2D6F", justifyContent:"center",textAlign:"center"}}>Let's change your look</h5>
...
export default SignUpForCustomerFinished;